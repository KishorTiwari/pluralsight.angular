...
export class PropertyService {
  ...
  getUserProperties(): Observable<HttpResponse<Property[]>>{
    let url = AppConstant.appUrl + '/api/property/user';
    let headers: HttpHeaders = this._header.getAuthHeader();
    return this._httpClient.get<Property[]>(url, {observe: 'response', headers: headers}).pipe(
